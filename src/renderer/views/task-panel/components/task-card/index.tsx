import { BaseSyntheticEvent, FC, ReactNode, useRef } from "react";
import { Card, Rate } from "antd";
import { FrownOutlined, MehOutlined, SmileOutlined } from "@ant-design/icons";
import { ITaskResult } from "@/renderer/types/task";
import { useDelTask } from "@/renderer/hooks/useTaskPonds";
import "./index.less";
...
const TaskCard: FC<ITaskCardProps> = (props) => {
  ...
  const starMap = (val: number) => {
    ...
    return (m.find((item) => item[1] === val) as [number, number])[0];
  };
